...
public class KeyInput extends KeyAdapter {
    ...
    private boolean keyT;
    private boolean keyU;
    ...
    private int keySPshot;
    private int keyUPshot;
    private int keyDOshot;
    private int keyLEshot;
    private int keyRIshot;
    private int keyENshot;

    private int keyAshot;
    private int keyCshot;
    private int keyEshot;
    private int keyTshot;
    private int keyUshot;
    private int keyWshot;
